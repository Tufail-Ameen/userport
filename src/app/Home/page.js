...
import { Cart } from '@/Components/Cards/Menu card/MenuCard';
    ...
    return (
        <CartProvider>
            <>
                ...
                {/* Landing Page */}
                <div className='mb-100 h-screen w-full bg-[url("/Landing_Page_4.jpg")] bg-cover bg-center flex items-center px-5 sm:pl-5 sm:pr-5 md:pl-2 md:pr-2 lg:pl-10 lg:pr-10'>
                    <div>
